...
outputFile = "simulationOutput1.log"
# Module logger
...
for i, (recommendation, liquidation_info) in enumerate(recommendations.values()):
    logger.info(f"Processing row {i+1} of {len(recommendations)}...")
